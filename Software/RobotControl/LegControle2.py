...
def LegStep(legArr,StepWidth, height, DelayArr=[0,1,1,1],vel=5):
    ...
    legUpMovemntTot= abs(alphaLift-legUpStartAngle)+abs(alphaStep-alphaLift)+abs(alphaInit-alphaStep);
    ...
    while True:
       ...
       for i in range(0,len(legArr)):
           ...
           print('Dif alphaSP-alphaStart: ',str(abs(alphaFin-legUpStartAngle)),'     Dif alphaSP-alphaCurrent: ',str(alphaFin-angleSetLegUp))
